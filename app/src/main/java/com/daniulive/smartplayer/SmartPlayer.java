...
//    }
    ...
    private void SaveInputUrl(String url) {
        ...
        txtUserDataMsg.setText( "当前地址:"+playbackUrl );
    ...
    private void inflateLayout(int orientation) {
        ...
        rl.topMargin = getWindowManager().getDefaultDisplay().getHeight() - 170;
...
//                .setText("Copyright 2014~2019 www.daniulive.com v1.0.18.0622");
        ...
        txtUserDataMsg.setLayoutParams(new LinearLayout.LayoutParams(
                ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        txtUserDataMsg.setText("");
        txtUserDataMsg.setTextColor(0xffff00ff);
        copyRightLinearLayout.addView(txtUserDataMsg, 1);



        btnPopInputUrl = new Button(this);
        btnPopInputUrl.setText("点击输入播放地址");
